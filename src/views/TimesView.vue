...
import { Printer, Edit, Plus } from 'lucide-vue-next';
                    ...
                    <div class="flex flex-col gap-2 border border-gray-200 rounded shadow p-4">
                        ...
                        <div id="start" class="flex flex-col gap-2 items-start">
                            <input required v-model="startDate" class="outline outline-1 px-2 py-1 rounded w-full"
                                type="date">
                            <input v-model="startTime" class="outline outline-1 px-2 py-1 rounded w-full" type="time">
                        </div>
                    </div>
                    <div class="flex flex-col gap-2 border border-gray-200 rounded shadow p-4">
        ...
        <div class=" p-8 flex flex-col gap-4">
            ...
            <div class="not-printable w-full h-fit border border-gray-200 rounded shadow p-4 flex flex-col gap-4">
                <div class=" flex flex-row items-center justify-between  w-full gap-8">
                    ...
                    <ButtonComponent @action="openDrawer = !openDrawer">
                        <template #icon>
                            <Plus></Plus>
                        </template>
                    </ButtonComponent>
